...
INSERT INTO produtos (descricao, preco_venda, preco_custo, id_categoria) VALUES ('Pendrive 320B', '120.54', '32.55', 2);
INSERT INTO produtos (descricao, preco_venda, preco_custo, id_categoria) VALUES ('Mouse', '17.00', '4.30', 2);
INSERT INTO produtos (descricao, preco_venda, preco_custo, id_categoria) VALUES ('Nitendo', '3000.00', '1500.30', 4);
...
-- estamos buscando o maior preço de venda emtodas as categoriasdeprodutos que temos. Ao final estamos agrupando pelo id da categoria.
SELECT id_categoria, MAX(preco_venda) FROM produtos GROUP BY id_categoria;
SELECT preco_venda, MAX(preco_venda) FROM produtos GROUP BY preco_venda;
...
SELECT SUM(preco_venda) FROM produtos;
